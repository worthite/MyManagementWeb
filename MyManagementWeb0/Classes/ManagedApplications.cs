...
namespace MyManagementWeb.Classes
{
    public class ManagedApplications
    {
        ...
        public async Task<string> ApplicationsInSubscription(string SubscriptionId)
        {
            ...
            var azureToken = await GetTokenAsync(SubscriptionId);
        ...
        internal static async Task<string> GetTokenAsync(string SubscriptionId)
        {

            string azureResource = "https://management.azure.com/";

            var azureServiceTokenProvider = new AzureServiceTokenProvider();
            string accessToken = await azureServiceTokenProvider.GetAccessTokenAsync(azureResource);
